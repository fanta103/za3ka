...
const ExperienceSection: React.FC<ExperienceSectionProps> = ({ userData, isOwnProfile, onSave }) => {
	const [isEditing, setIsEditing] = useState(false);
	const [experiences, setExperiences] = useState<IExperience[]>(userData.experience || []);
	const [newExperience, setNewExperience] = useState<IExperience & { currentlyWorking: boolean }>({
		title: "",
		company: "",
		startDate: "",
		endDate: "",
	...
	const handleAddExperience = () => {
		if (newExperience.title && newExperience.company && newExperience.startDate) {
			const { currentlyWorking, ...expData } = newExperience;
			setExperiences([...experiences, expData]);
