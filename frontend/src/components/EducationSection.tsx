...
import { IUser, IEducation } from "../types";
...
const EducationSection: React.FC<EducationSectionProps> = ({ userData, isOwnProfile, onSave }) => {
	const [isEditing, setIsEditing] = useState(false);
	const [educations, setEducations] = useState<IEducation[]>(userData.education || []);
